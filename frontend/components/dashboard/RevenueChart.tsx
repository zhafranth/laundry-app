...
import type { DashboardRevenueSeries } from "@/types";

interface RevenueChartProps {
  data: DashboardRevenueSeries[];
  isLoading?: boolean;
}
    ...
    <div>
      ...
      {isEmpty ? (
        <div
          ...
          style={{ height: 180, background: "#F5F7FA", border: "1px dashed #C4CDD6" }}
        >
          <p
            style={{
              fontFamily: "Nunito Sans, system-ui",
        ...
        <ResponsiveContainer width="100%" height={180}>
          <AreaChart data={data} margin={{ top: 4, right: 4, left: -16, bottom: 0 }}>
            ...
            <Area
              ...
              activeDot={{ r: 5, fill: "#00B4D8", stroke: "white", strokeWidth: 2 }}
            />
          </AreaChart>
        </ResponsiveContainer>
      )}
