...
import { restockSchema, type RestockFormValues } from "@/schemas/inventory";
...
export function RestockModal({ item, onSubmit, onClose, isPending }: Props) {
  const {
    register,
    handleSubmit,
    formState: { errors },
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <PackagePlus size={16} color="#00B4D8" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label style={{ display: "block", fontFamily: "Manrope, system-ui", fontWeight: 700, fontSize: "0.78rem", color: "#5A6B80", marginBottom: 6 }}>
                Qty Masuk ({item.unit}) <span style={{ color: "#EF4444" }}>*</span>
              </label>
              <input
                type="number"
