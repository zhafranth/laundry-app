  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Sisa bayar: {formatRupiah(order.remainingAmount)}
        </p>
            ...
            {(["tunai", "transfer", "qris"] as PaymentMethod[]).map((m) => (
              <button
                ...
                style={{
                  ...
                  background:
                    method === m ? "rgba(0,180,216,0.06)" : "white",
      ...
      >
        ...
        <div className="flex flex-col gap-1.5 mb-5">
          ...
          <textarea
            ...
            placeholder="Contoh: pelanggan cancel, barang tidak jadi..."
            style={{
              padding: "10px 12px",
              borderRadius: 10,
  ...
  return (
    <div className="flex flex-col gap-5 pb-8">
        ...
        <div className="xl:col-span-2 flex flex-col gap-5">
              ...
              <InfoRow
                ...
                value={
                  order.estimatedFinishedAt
                    ? new Date(order.estimatedFinishedAt).toLocaleDateString("id-ID", {
                        day: "numeric",
                        month: "short",
                        year: "numeric",
                      })
          ...
          >
            ...
            <div
              ...
              style={{ borderTop: "1.5px solid #E8EDF2" }}
            >
              <span
                style={{
                  fontFamily: "Manrope, system-ui",
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <InfoRow
                label="Status"
                value={payConfig.label}
                valueColor={payConfig.color}
              />
              <InfoRow
                label="Total"
        ...
        <div className="flex flex-col gap-5">
          ...
          {order.status !== "selesai" && order.status !== "dibatalkan" && (
            <div
              ...
              style={{
                background: "white",
                border: "1.5px solid rgba(239,45,86,0.15)",
                boxShadow: "0 2px 8px rgba(11,29,53,0.06)",
              }}
            >
              <p
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  style={{
                    height: 38,
                    borderRadius: 10,
                    border: "1.5px solid rgba(239,45,86,0.25)",
                    background: "rgba(239,45,86,0.04)",
                    color: "#EF2D56",
                    fontFamily: "Manrope, system-ui",
                    fontWeight: 700,
                    fontSize: "0.8rem",
                ...
                <button
                  onClick={() => {
                    if (
                      confirm(
                        `Hapus order ${order.orderNumber}? Tindakan ini tidak bisa dibatalkan.`
                      )
                    ) {
                      deleteOrder();
                    }
      ...
      {showMarkPaid && (
        <MarkPaidModal
          order={order}
          onConfirm={(method) => markPaid(method)}
      ...
      {showCancel && (
        <CancelModal
          order={order}
          onConfirm={(note) =>
            updateStatus({ status: "dibatalkan", note })
          }
